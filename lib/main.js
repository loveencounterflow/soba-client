...
(function() {
  var $, BNP, D, D2, SOBAC, TEXT, TRM, alert, badge, debug, f, help, info, new_socket, njs_fs, njs_path, rpr, socket, urge, warn, whisper, wrap_as_socket_stream,
    __slice = [].slice;
  ...
  this.dump = function(me, settings, handler) {
    ...
    return stream.pipe(D2.$split()).pipe($((function(_this) {
      ...
      return function(event, send) {
        var idx, key, tail, type, value, _ref;
