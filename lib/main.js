...
(function() {
  var $, D, SOBAC, TEXT, TRM, alert, badge, debug, f, help, info, new_socket, njs_fs, njs_path, rpr, socket, urge, warn, whisper, wrap_as_socket_stream,
    __slice = [].slice;
  ...
  this.dump = function(me, _XXX_name, settings, handler) {
    ...
    return stream.pipe(D.$split()).pipe($((function(_this) {
      return function(line, send) {
        if ((line != null) && line.length > 0) {
          return send([_XXX_name, JSON.parse(line)]);
        }
      };
    })(this))).pipe(D.$show());
  };
